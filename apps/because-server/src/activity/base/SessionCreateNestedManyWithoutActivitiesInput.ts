...
@InputType()
class SessionCreateNestedManyWithoutActivitiesInput {
...
export { SessionCreateNestedManyWithoutActivitiesInput as SessionCreateNestedManyWithoutActivitiesInput };
